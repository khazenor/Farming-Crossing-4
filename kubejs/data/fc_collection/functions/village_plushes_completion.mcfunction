...
scoreboard players add @p village_plushes_completion 1
tellraw @p ["", {"text":"Village Plushes Completion ("}, {"score":{"name":"@p","objective":"village_plushes_completion"}}, {"text":"/10)"}]
tellraw @p [""]
