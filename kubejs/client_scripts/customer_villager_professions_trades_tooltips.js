ItemEvents.tooltip(event => {
  ...
  event.add(
    ...
    [
      'A candlelight customer villager regularly', 
      'buys 2 of this meal for 3 tickets'
    ])
  event.add(
  ...
  event.add(
    ...
    [
      'A candlelight customer villager regularly', 
      'buys 6 of this meal for 6 tickets'
    ])
  event.add(
		'candlelight:pasta_bolognese',
    [
      'A candlelight customer villager regularly', 
      'buys this meal for 6 tickets'
    ])
  event.add(
		'candlelight:beef_wellington',
    [
      'A candlelight customer villager regularly', 
      'buys this meal for 9 tickets'
    ])
  event.add(
