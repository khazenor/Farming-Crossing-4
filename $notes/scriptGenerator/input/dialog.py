...
dialogs = [
  {
    ...
    questIdKey: "63E0AA34BF62B951" # 5 food
  }, {
    ...
    questIdKey: "6FD0771D5735E898" # 10 food
  }, {
    ...
    questIdKey: "3AB5ADA435969636" # 35 food
  }, {
    ...
    questIdKey: "7EBEA8535B48079B" # mineral 5
  }, {
    nameKey: 'Laly 10',
    speakerKey: laly,
    ...
    questIdKey: "5A4AA7C9BA18CB2C" # 5 fish
  }, {
    nameKey: 'Sam 10',
    speakerKey: sam,
    ...
    questIdKey: "4C057935B5D13261"
  }, {
    nameKey: "Bernina Introduces Herself",
    speakerKey: bernina,
    questIdKey: "1D961C7CC31D3DA5", # player collects 5 common decorations
    textsKey: [
    ...
    speakerKey: bernina,
    questIdKey: "63B3DEB3D6738664", # player collects 10 common decorations
    textsKey: [
