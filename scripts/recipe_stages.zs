...
mods.recipestages.Recipes.setRecipeStage("light_hook", <item:aquaculture:light_hook>);
mods.recipestages.Recipes.setRecipeStage("heavy_hook", <item:aquaculture:heavy_hook>);
mods.recipestages.Recipes.setRecipeStage("double_hook", <item:aquaculture:double_hook>);
mods.recipestages.Recipes.setRecipeStage("redstone_hook", <item:aquaculture:redstone_hook>);
mods.recipestages.Recipes.setRecipeStage("note_hook", <item:aquaculture:note_hook>);
mods.recipestages.Recipes.setRecipeStage("nether_star_hook", <item:aquaculture:nether_star_hook>);

mods.recipestages.Recipes.setRecipeStage("crafting_grid", <item:refinedstorage:crafting_grid>);
mods.recipestages.Recipes.setRecipeStage("1k_storage_disk", <item:refinedstorage:1k_storage_disk>);
